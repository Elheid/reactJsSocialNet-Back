...
{
    /// <inheritdoc />
    public partial class initWithNewEntity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Comment_Parents", "(post_id IS NOT NULL AND message_id IS NULL) OR (post_id IS NULL AND message_id IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comment_Message_Created",
                table: "Comments",
                columns: new[] { "message_id", "Created" });

            migrationBuilder.CreateIndex(
                name: "IX_Comment_Post_Created",
                table: "Comments",
                columns: new[] { "post_id", "Created" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Message_Dialog_Created",
                table: "Messages",
                columns: new[] { "DialogId", "Created" });
